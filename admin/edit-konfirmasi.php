...
<html>
    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
			...
			$sql="UPDATE konfirmasi SET status='$status' WHERE id_kon='$id_kon'" or die(mysqli_error());
			$res=mysqli_query($koneksi, $sql) or die (mysqli_error());
			if($sql){
					echo "<script>alert('Data berhasil diupdate!'); window.location = 'konfirmasi.php'</script>";
				}else{
           ...
           <!-- /.row -->
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
						  ...
						  <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Gambar Bukti Transfer</label>
                              <div class="col-sm-3">
