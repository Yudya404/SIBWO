            ...
            <aside class="right-side">
              ...
              ?>
                  ...
                  <!-- </div>
                        ...
                        <div class="panel-heading">
                        <h3 class="panel-title"><span class="glyphicon glyphicon-tag"></span> Riwayat Pemesanan </h3> 
                        </div>
                        <div class="panel-body">
                       <!-- <div class="table-responsive"> -->
                    <?php
                  ...
                  <thead>
                    ...
                    <td><center>
					<?php
                            if($data2['status_pelayanan'] == 'Selesai'){
								echo '<span class="label label-success">Selesai</span>';
							}
                            else if ($data2['status_pelayanan'] == 'Proses' ){
								echo '<span class="label label-warning">Proses</span>';
							}
							else if ($data2['status_pelayanan'] == 'Batal' ){
								echo '<span class="label label-danger">Batal</span>';
							}
							else if ($data2['status_pelayanan'] == 'Belum Bayar' ){
                    ...
                    <td><center><div id="thanks">
                    <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Konfirmasi Pemesanan" href="edit-konfirmasi-pesan.php?hal=edit&kode=<?php echo $data2['id'];?>"><span class="glyphicon glyphicon-edit"></span></a>
                    </div></center></td>
                    </tr></div>
                 <?php   
              } 
              ?>
                  ...
                  <thead>
                    ...
                    <td><center><?php
                            if($data2['status'] == 'Sudah Bayar'){
								echo '<span class="label label-success">Sudah Bayar</span>';
							}
                            else if ($data2['status'] == 'Belum Bayar' ){
								echo '<span class="label label-danger">Belum Bayar</span>';
							}
