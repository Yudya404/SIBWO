        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Konfirmasi Pemesanan Pelanggan
                        <small>Administrator</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Konfirmasi Pemesanan</a></li>
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i>Konfirmasi Pemesanan</h3> 
                        </div>
                        <div class="panel-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-konfirmasi-pesan.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="kd_cus" type="text" id="kd_cus" value="<?php echo $row['nama']; ?>" class="form-control" autocomplete="off" readonly="readonly" />
						  ...
						  <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="tanggal" type="date" id="tanggal" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" required />
						  ...
						  <div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label">Status</label>
									<div class="col-sm-3">
										<select id="status_pelayanan" name="status_pelayanan" class="form-control" required>
                            ...
                            else if ($row['status_pelayanan'] == 'Proses' ){
								echo '<span class="label label-warning">Proses</span>';
							}
							else if ($row['status_pelayanan'] == 'Batal' ){
								echo '<span class="label label-danger">Batal</span>';
							}
							else if ($row['status_pelayanan'] == 'Belum Bayar' ){
