...
$result=mysqli_query($koneksi, "SELECT po_terima.*, konfirmasi.jumlah, produk.kode AS kode_prod, produk.nama, produk.harga, customer.alamat, customer.no_telp, customer.nama AS nama_cus, po_terima.status_pelayanan FROM po_terima
...
$pdf->Image('img/logo.jpg',10,10,-175);
//$pdf->Image('../images/BBRI.png',190,10,-200);
$pdf->SetFont('Arial','B',13);
$pdf->Cell(80);
$pdf->Cell(30,10,'Bukti Pemesanan',0,0,'C');
$pdf->Ln();
$pdf->Cell(80);
$pdf->Cell(30,10,'Imagine Organizer',0,0,'C');
$pdf->Ln();
...
$pdf->Cell(25,8,'',0,0,'C',1);
$pdf->SetX(160);
$pdf->Cell(45,8,'Tanggal Order : '.$tanggal,0,0,'R',1);
$pdf->Ln();
}
//Fields Name position
...
$pdf->Cell(30,10,'( ............................................................)',0,0,'C');
**/
$pdf->Output("Bukti Pemesanan.pdf","I");
}
?>
